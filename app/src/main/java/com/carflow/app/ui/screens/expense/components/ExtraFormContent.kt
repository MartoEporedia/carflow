...
import com.carflow.app.ui.screens.expense.viewmodel.ExtraFormState
...
fun ExtraFormContent(
    ...
    Column(
        ...
        Text("Aggiungi spesa extra", style = MaterialTheme.typography.titleLarge)
        ...
        OutlinedTextField(
            ...
            placeholder = { Text("Es: Assicurazione, Multa, Bollo...") },
            minLines = 2,
            maxLines = 4,
            modifier = Modifier.fillMaxWidth()
        )
...
@Composable
private fun ExtraFormContentPreview() {
    ExtraFormContent(
        state = ExtraFormState(amount = "120", description = "Assicurazione"),
        onStateChange = {},
        onSave = {}
    )
}
